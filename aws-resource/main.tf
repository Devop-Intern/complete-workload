...
module "rds" {
  ...
  rds_monitoring_interval     = var.rds.app.rds_monitoring_interval
  rds_monitoring_role_name    = var.rds.app.rds_monitoring_role_name
  ...
  family                      = var.rds.app.family
  backup_retention_period     = var.rds.app.backup_retention_period
